...
const allProducts = [
    // Товары для женщин
    {
        ...
        price: 2500,
        image: "https://via.placeholder.com/300x200/7e57c2/FFFFFF?text=Свечи+люкс",
        category: "уход",
    ...
    },
    {
        ...
        price: 4500,
        image: "https://via.placeholder.com/300x200/7e57c2/FFFFFF?text=Косметика",
        category: "уход",
    ...
    },
    {
        ...
        price: 3200,
        image: "https://via.placeholder.com/300x200/7e57c2/FFFFFF?text=Шелк+платок",
        category: "аксессуары",
    ...
    // Товары для мужчин
    {
        ...
        price: 2800,
        image: "https://via.placeholder.com/300x200/5e35b1/FFFFFF?text=Борода+набор",
        category: "уход",
    ...
    },
    {
        ...
        price: 5200,
        image: "https://via.placeholder.com/300x200/5e35b1/FFFFFF?text=Колонка+умная",
        category: "техника",
        occasion: ["birthday", "holiday"],
        recipient: "male",
    ...
    },
    {
        ...
        price: 12990,
        image: "https://via.placeholder.com/300x200/5e35b1/FFFFFF?text=Умные+часы",
        category: "техника",
...
function updateResultsCount(count) {
    ...
    const countText = count === 0 ? 'ничего не найдено' : `${count} подарк${getRussianPlural(count)}`;
